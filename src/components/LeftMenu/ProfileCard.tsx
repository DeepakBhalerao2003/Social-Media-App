    ...
    <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6">
      <div className="h-20 relative">
        ...
        <Image 
            ...
            alt=""
            width={48} height={48}
            className="rounded-full w-12 h-12 absolute left-0 right-0 m-auto -bottom-6 ring-2 ring-white z-10 object-cover"
        />
      </div>

      <div className="h-20 flex flex-col gap-2 items-center">
        <span className="font-semibold">{(user.fname && user.surname ) ? user.fname + " " + user.surname :  user.username}</span>
